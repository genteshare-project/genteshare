...
Genteshare Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Genteshare Core, where everyone uses
...
pay attention to for reviewers of Genteshare Core code.

General Genteshare Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Genteshare Core uses tinyformat, which is type safe. Leave them out to avoid confusion
