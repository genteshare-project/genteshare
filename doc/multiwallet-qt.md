...
Only requiring some minor changes is genteshare.cpp.
...
Changes to genteshare.cpp
----------------------
genteshare.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
