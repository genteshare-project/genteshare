...
This mechanism has been integrated into Bitcore-Node-Genteshare which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/genteshare-project/insight-api-genteshare#web-socket-api](https://github.com/genteshare-project/insight-api-genteshare#web-socket-api)
* API: [https://github.com/genteshare-project/insight-api-genteshare#instantsend-transactions](https://github.com/genteshare-project/insight-api-genteshare#instantsend-transactions)
...
By default, the Genteshare Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Genteshare Core daemon:
