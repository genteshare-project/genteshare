    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("GENTESHARE-light"), QVariant("light"));
    ui->theme->addItem(QString("GENTESHARE-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("GENTESHARE-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("GENTESHARE-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("GENTESHARE-traditional"), QVariant("trad"));
