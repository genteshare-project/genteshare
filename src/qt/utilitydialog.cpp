    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Genteshare Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Genteshare Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  genteshare-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Genteshare in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 GENTESHARE, 0.1 GENTESHARE, 1 GENTESHARE and 10 GENTESHARE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://genteshare-project.atlassian.net/wiki/display/DOC/PrivateSend\">https://genteshare-project.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Genteshare Core is shutting down...") + "<br /><br />" +
