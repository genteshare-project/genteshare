    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Genteshare Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Genteshare address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and genteshare: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Genteshare Core"), this);
    aboutAction->setStatusTip(tr("Show information about Genteshare Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Genteshare Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Genteshare addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Genteshare addresses"));
    ...
    openAction->setStatusTip(tr("Open a genteshare: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Genteshare Core help message to get a list with possible Genteshare Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Genteshare Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Genteshare network", "", count));
    } else {
...
{
    QString strTitle = tr("Genteshare Core"); // default title
    ...
    // Append title to "Genteshare Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
