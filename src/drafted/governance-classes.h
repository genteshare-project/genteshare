 ...
 *
 *   // network
 *   CGenteshareNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.gentecoin.com/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CGenteshareNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CGenteshareNetwork(UniValue objIn)
    {
...
// // can be under: GenteshareNetwork
// //   -- signature requirements : Key1(User)
// class CGenteshareNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == GenteshareNetwork);
//     // }
