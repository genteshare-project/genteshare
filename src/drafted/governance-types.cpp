...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GenteshareNetwork") type = GenteshareNetwork;
    if(strType == "GenteshareNetworkVariable") type = GenteshareNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GenteshareNetwork) s = "GenteshareNetwork";
    if(type == GenteshareNetworkVariable) s = "GenteshareNetworkVariable";
