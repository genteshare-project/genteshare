...
#define BOOST_TEST_MODULE Genteshare Test Suite

#include "test_genteshare.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_genteshare_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
