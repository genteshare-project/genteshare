...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Genteshare Core genteshare-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  genteshare-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded genteshare transaction") + "\n" +
              "  genteshare-tx [options] -create [commands]   " + _("Create hex-encoded genteshare transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded genteshare transaction
